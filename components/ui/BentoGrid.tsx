...
export const BentoGridItem = ({
  ...
  const leftLists = ["Green Screen", "Decor"];
  const rightLists = ["Podcast", "Audio", "Camera"];
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center relative"} h-full`}>
        ...
        >
          ...
          <div className="font-sans md:max-w-80 md:text-xs lg:text-base text-md text-[#C1C2D3] z-10">
            {description}
          </div>
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                {leftLists.map((item, i) => (
                  <span
                    ...
                    lg:opacity-100 rounded-lg text-center bg-[#1a653f]"
                  >
                    {item}
                  </span>
                ))}
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                ...
                {rightLists.map((item, i) => (
                  <span
                    key={i}
                    className="lg:py-4 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 
                    lg:opacity-100 rounded-lg text-center bg-[#711a1a]"
                  >
                    {item}
                  </span>
                ))}
